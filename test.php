        ...
        <div class="table1 contents">
          <table style="width: 100%; border-spacing: 0px 60px;">
            ...
            <tr>
              <td>
                <div class="table2 ">
                  <table class="brdr" style="border-collapse: collapse; width: 100%; height: 130px;">
                    <tr>
                      <th class="brdr bluehead">Customer</th>
                    </tr>
                    <tr>
                      <td>Mr.SAFIULLAH TAJ AHMED</td>
                    </tr>
                    <tr>
